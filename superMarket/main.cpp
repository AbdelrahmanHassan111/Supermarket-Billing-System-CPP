...
///////////////////////////////////////////////////////////////////////
 ...
 int membership()
 {
      ...
      {              //    show that item you have bought
        ...
        if(pay>=3000){
        							          //    coupon
        cout<<"\n You have won coupon worth EGP 500 "<< "\nThank you for shopping !\n\n";
		}
         else{
...
int main()
{
	...
	cout<<"--------------------------------------------------"<<endl;
   	gotoxy(17,11);
   	cout<<"|Subject Teacher ->> Dr. shaker <<-- |\n"<<endl;
   	gotoxy(17,13);
   	cout<<">>>----Project Implemented By-----<<<"<<endl;
    gotoxy(22,15);
   	cout<<"Ahmed Nabil (221200046)"<<endl;
   	gotoxy(22,16);
   	cout<<"sarah khaled  (221200047)"<<endl;
   	gotoxy(22,17);
   	cout<<"ahmed ashraf   (200000021)"<<endl;
   	gotoxy(22,18);
   	cout<<"ahmed salama  (221200049)"<<endl;
   	gotoxy(22,19);
   	cout<<"Mohamed adel  (221200054)"<<endl;
   	gotoxy(22,20);
   	cout<<"Yehia abozahra  (221200051)"<<endl;
   	gotoxy(22,21);
   	cout<<"ammar mohamed  (221200048)"<<endl<<endl;
	system("pause");
	system("cls");
	system("color Fc");
	///////////////////////////
